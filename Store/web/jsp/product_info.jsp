	...
	<%@ include file="header.jsp"%>
		...
		<div class="container">
			<div class="row">
				...
				<form id="myForm" method="post" action="${pageContext.request.contextPath}/CartServlet?method=addItemToCart">
						<div class="col-md-6">
							...
							<div style="margin:10px 0 10px 0;">商场价: <strong style="color:#ef0101;">￥：${product.shop_price}元/份</strong> 参 考 价： <del>￥${procuct.market_price}元/份</del>
							</div>
