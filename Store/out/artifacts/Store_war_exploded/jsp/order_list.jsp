					...
					<table class="table table-bordered">
						<c:forEach items="${page.records}" var="o">
							<tbody>
								<tr class="success">
									<th colspan="5">
										订单编号:${o.oid}  金额：￥${o.total}
										<c:if test="${o.state==1}">
											未付款 <a href="${pageContext.request.contextPath}/OrderServlet?method=findOrderByOrderId&oid=${o.oid}"> 付款</a>
										</c:if>
										<c:if test="${o.state==2}">
											<a href="">待发货</a>
										</c:if>
								...
								<c:forEach items="${o.list}" var="orderItem">
									<tr class="active">
